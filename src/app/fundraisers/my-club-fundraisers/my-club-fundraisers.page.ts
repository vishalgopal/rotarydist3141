...
@Component({
  selector: 'app-my-club-fundraisers',
  templateUrl: './my-club-fundraisers.page.html',
  styleUrls: ['./my-club-fundraisers.page.scss'],
})
export class MyClubFundraisersPage implements OnInit {
