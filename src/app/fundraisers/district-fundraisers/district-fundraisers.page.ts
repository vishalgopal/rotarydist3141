...
@Component({
  selector: 'app-district-fundraisers',
  templateUrl: './district-fundraisers.page.html',
  styleUrls: ['./district-fundraisers.page.scss'],
})
export class DistrictFundraisersPage implements OnInit {
