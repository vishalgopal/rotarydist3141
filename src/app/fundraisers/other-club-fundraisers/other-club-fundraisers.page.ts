...
@Component({
  selector: 'app-other-club-fundraisers',
  templateUrl: './other-club-fundraisers.page.html',
  styleUrls: ['./other-club-fundraisers.page.scss'],
})
export class OtherClubFundraisersPage implements OnInit {
