...
@Component({
  selector: 'app-other-club-projects',
  templateUrl: './other-club-projects.page.html',
  styleUrls: ['./other-club-projects.page.scss'],
})
export class OtherClubProjectsPage implements OnInit {
