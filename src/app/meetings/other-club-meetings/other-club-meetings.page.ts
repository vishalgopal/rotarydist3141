...
@Component({
  selector: 'app-other-club-meetings',
  templateUrl: './other-club-meetings.page.html',
  styleUrls: ['./other-club-meetings.page.scss'],
})
export class OtherClubMeetingsPage implements OnInit {
