...
@Component({
  selector: 'app-my-club-meetings',
  templateUrl: './my-club-meetings.page.html',
  styleUrls: ['./my-club-meetings.page.scss'],
})
export class MyClubMeetingsPage implements OnInit {
