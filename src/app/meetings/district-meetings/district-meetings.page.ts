...
@Component({
  selector: 'app-district-meetings',
  templateUrl: './district-meetings.page.html',
  styleUrls: ['./district-meetings.page.scss'],
})
export class DistrictMeetingsPage implements OnInit {
